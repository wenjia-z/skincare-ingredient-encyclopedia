...
export default defineIngredient({
  ...
  tradeNames: [
    { name: 'ABIL EM 90', supplier: 'Evonik' },
    { name: 'ABIL EM 180', supplier: 'Evonik' },
    { name: 'Emulsogen WSi', supplier: 'Clariant' },
  ],
  chemicalClass: {
  ...
  citations: [
    ...
    {
      id: 'scribd-abilem180-tds-tradename',
      supplier: 'Evonik (via a Scribd-hosted TDS document)',
      documentTitle: 'DS ABIL EM 180 — Technical Data Sheet',
      url: 'https://www.scribd.com/document/717734289/DS-ABIL-EM-180',
      accessedDate: '2026-08-06',
      note: "Confirms ABIL EM 180 is a distinct Evonik product sharing the same INCI as ABIL EM 90 (Cetyl PEG/PPG-10/1 Dimethicone), added here as an additional trade name per this project's dedupe policy rather than as a separate entry. This document gives ABIL EM 180-specific figures that differ from EM 90's own TDS values: HLB ~5, viscous liquid appearance, recommended use levels (gels 0.5-1.0%, lotions 0.5-1.5%, creams 1.0-2.5%), oil-phase range 20-40%, pH tolerance 4.5-9.0, and NaCl tolerance 0.05-5.0% — evidence that EM 90 and EM 180 are different molecular-weight/viscosity grades within the same INCI family, not identical products. These EM-180-specific numbers are not merged into this entry's own performance/typicalUseLevel fields (which describe EM 90 specifically) to avoid conflating the two grades.",
    },
    {
      id: 'clariant-emulsogen-wsi-tradename',
      supplier: 'Clariant',
      documentTitle: 'Emulsogen WSi — Product Page',
      url: 'https://www.clariant.com/en/Solutions/Products/2021/04/21/08/30/Emulsogen-WSi',
      accessedDate: '2026-08-06',
      note: "Clariant's own official product page, fetched directly, confirms Emulsogen WSi's INCI is also Cetyl PEG/PPG-10/1 Dimethicone — the same generic INCI as ABIL EM 90/EM 180 — despite being sold by a different supplier under a different trade name. Added here as an additional trade name per this project's dedupe policy. The page describes it as a high-molecular-weight, ethylene-oxide-free silicone emulsifier for W/O or W/Si emulsions (sunscreens, body milks, color cosmetics), pH-stable over a broad range; no separate numeric HLB/viscosity/use-level figures were given on this page, so no EM-90-specific field values were altered based on this source.",
    },
  ],
